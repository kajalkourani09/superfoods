...
import back from '../assests/images/Essential Back.png'
    ...
    return (
      ...
      <div className='container-fluid'  ref={refe}>
        ...
        <Navbar></Navbar>
              ...
              <h1 className='producthead'>Essential Raw Makhana</h1>
              <div className='row buttonrounded' style={{display:"flex",flexDirection:"row"}}>
                  ...
                  <div>
                  <img src={fill} style={{width:"20px",height:"20px",margin:"0px",marginRight:"5px"}}></img>
                  </div>
                  <div>
                  ...
                  <div className='box' style={{width:"160px",height:"50px",backgroundColor:"",margin:"15px",borderStyle:"solid",borderRadius:"30px",display:"flex",justifyContent:"center",alignItems:"center"}}>
                  <p style={{fontSize:"large",marginTop:"13px"}}>4-5-6+ Suta</p>
                  </div>
                 
              </div>
              <h4 className='xar' style={{marginTop:"3vh"}}>All grade mix | Price Friendly </h4>
              ...
              <div className='row' style={{marginTop:"10vw"}}>
                ...
                <div className='col'>
                  ...
                  <div className='row'>
                    <p className='xas' style={{padding:"10px",marginTop:"1.8vw"}}>The everyday nutrition variant is a mixed bag of all 4, 5, and 6 suta Makhanas, a budget-friendly option without compromising on the taste and health benefits of this holistic superfood. </p>
                  </div>
                </div>
              </div>
