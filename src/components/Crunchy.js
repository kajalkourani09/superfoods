    ...
    return (
      ...
      <div className='container-fluid'  ref={refe}>
        ...
        <Navbar></Navbar>
              ...
              <h1 className='producthead'>Crunchy Raw Makhana</h1>
              <div className='row buttonrounded' style={{display:"flex",flexDirection:"row"}}>
                  ...
                  <div>
                  <img src={blank} style={{width:"30px",height:"30px",margin:"0px",marginRight:"5px"}}></img>
                  </div>
                  <div>
                  ...
                  <div>
                  <img src={fill} style={{width:"15px",height:"15px",margin:"0px",marginRight:"5px"}}></img>
                  </div>
                </div>
                  </div>
                  <div className='box' style={{width:"160px",height:"50px",backgroundColor:"",margin:"15px",borderStyle:"solid",borderRadius:"30px",display:"flex",justifyContent:"center",alignItems:"center"}}>
                  <p style={{fontSize:"large",marginTop:"13px"}}>3-4 Suta</p>
                  </div>
                  
              </div>
              <h4 className='xar' style={{marginTop:"3vh"}}>Mini-sized | Quick Roast</h4>
              ...
              <div className='row' style={{marginTop:"10vw"}}>
                ...
                <div className='col'>
                  ...
                  <div className='row'>
                    <p className='xas' style={{padding:"10px",marginTop:"1.8vw"}}>For those who have a knack for a crunchy snack. Evenly small and crunchy 3 and 4 suta Makhanas for those quick roast sessions with friends and family. </p>
                  </div>
                </div>
              </div>
